<template>
  <div>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
      ...
      <a
        href=""
        class="intro-y col-span-12 lg:col-span-4 box py-10 border-2 border-theme-25 dark:border-theme-1"
      >
        <ShieldIcon
          class="block w-12 h-12 text-theme-25 dark:text-theme-1 mx-auto"
        />
