  ...
  <div>
    <div class="intro-y news xl:w-3/5 p-5 box mt-8">
      ...
      >
        ...
        <a class="text-theme-25 dark:text-theme-22" href="">{{
      ...
      <div class="intro-y flex relative pt-16 sm:pt-6 items-center pb-6">
        ...
        <Tippy
          tag="a"
          href=""
          class="intro-x w-8 h-8 sm:w-10 sm:h-10 flex flex-none items-center justify-center rounded-full bg-theme-19 dark:bg-dark-5 dark:text-gray-300 text-theme-22 ml-auto sm:ml-0"
          content="Share"
        >
        ...
        <Tippy
          tag="a"
          href=""
          class="intro-x w-8 h-8 sm:w-10 sm:h-10 flex flex-none items-center justify-center rounded-full bg-theme-25 text-white ml-3"
