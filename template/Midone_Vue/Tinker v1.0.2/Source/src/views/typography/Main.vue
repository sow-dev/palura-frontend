        ...
        <div class="intro-y box">
          ...
          <div id="heading" class="p-5">
            <div class="preview">
              ...
              <div class="mt-5">
                <h1 class="text-4xl text-theme-25 font-medium leading-none">
                  h1. Heading 1
                </h1>
                <h2
                ...
                <h3
                  class="text-2xl text-theme-20 font-medium leading-none mt-3"
                >
                  h3. Heading 3
                </h3>
                <h4 class="text-xl text-theme-15 font-medium leading-none mt-3">
                  h4. Heading 4
                </h4>
                <h5 class="text-lg text-theme-21 font-medium leading-none mt-3">
                  h5. Heading 5
                </h5>
                  ...
                  >
                    <textarea>
                      ...
                      <div class="mt-5">
                        ...
                        <h3 class="text-2xl text-theme-20 font-medium leading-none mt-3">
                          h3. Heading 3
                        </h3>
                        <h4 class="text-xl text-theme-15 font-medium leading-none mt-3">
                          h4. Heading 4
        ...
        <div class="intro-y box">
          ...
          <div id="badge" class="p-5">
            <div class="preview">
              ...
              <div class="mt-2">
                <span
                  class="text-xs px-1 rounded-full bg-theme-25 text-white mr-1"
                  >1</span
                >
                <span
                ...
                >
                <span
                  class="text-xs px-1 rounded-full bg-theme-20 text-white mr-1"
                  >3</span
                >
                <span
                  class="text-xs px-1 rounded-full bg-theme-15 text-white mr-1"
                  >4</span
                >
                <span
                  class="text-xs px-1 rounded-full bg-theme-21 text-white mr-1"
                  >5</span
                >
                <span
              ...
              <div class="mt-3">
                <span class="px-2 py-1 rounded-full bg-theme-25 text-white mr-1"
                  >1</span
                >
                <span
                  ...
                  >2</span
                >
                <span class="px-2 py-1 rounded-full bg-theme-20 text-white mr-1"
                  >3</span
                >
                <span class="px-2 py-1 rounded-full bg-theme-15 text-white mr-1"
                  >4</span
                >
                <span class="px-2 py-1 rounded-full bg-theme-21 text-white mr-1"
                  >5</span
                >
                <span
              ...
              <div class="mt-4">
                <span class="px-3 py-2 rounded-full bg-theme-25 text-white mr-1"
                  >1</span
                >
                <span
                  ...
                  >2</span
                >
                <span class="px-3 py-2 rounded-full bg-theme-20 text-white mr-1"
                  >3</span
                >
                <span class="px-3 py-2 rounded-full bg-theme-15 text-white mr-1"
                  >4</span
                >
                <span class="px-3 py-2 rounded-full bg-theme-21 text-white mr-1"
                  >5</span
                >
                <span
              ...
              <div class="mt-6">
                <span class="px-4 py-3 rounded-full bg-theme-25 text-white mr-1"
                  >1</span
                >
                <span
                  ...
                  >2</span
                >
                <span class="px-4 py-3 rounded-full bg-theme-20 text-white mr-1"
                  >3</span
                >
                <span class="px-4 py-3 rounded-full bg-theme-15 text-white mr-1"
                  >4</span
                >
                <span class="px-4 py-3 rounded-full bg-theme-21 text-white mr-1"
                  >5</span
                >
                <span
              ...
              <div class="mt-4">
                <span
                  class="px-3 py-2 rounded-full border border-theme-25 text-theme-25 dark:text-theme-10 dark:border-theme-10 mr-1"
                  >1</span
                >
                <span
                  class="px-3 py-2 rounded-full border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1"
                ...
                >
                <span
                  class="px-3 py-2 rounded-full border border-theme-20 text-theme-20 dark:border-theme-20 mr-1"
                  >3</span
                >
                <span
                  class="px-3 py-2 rounded-full border border-theme-15 text-theme-15 dark:border-theme-15 mr-1"
                  >4</span
                >
                <span
                  class="px-3 py-2 rounded-full border border-theme-21 text-theme-21 dark:border-theme-21 mr-1"
                  >5</span
                >
              </div>
            </div>
            ...
            <div class="preview">
              <div>
                <a href="" class="text-theme-25 block font-normal"
                  >Example text</a
                >
                <a href="" class="text-theme-25 block font-medium"
                  >Example medium text</a
                >
                <a href="" class="text-theme-25 block font-semibold"
                  >Example semibold text</a
                >
                <a href="" class="text-theme-25 block font-bold"
                  >Example bolder text</a
                >
                <a href="" class="text-theme-25 block font-extrabold"
