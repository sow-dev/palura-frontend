              ...
              <div class="flex flex-col sm:flex-row">
                ...
                <div class="flex">
                  ...
                  <div class="text-center">
                    ...
                    <div class="bg-theme-17 text-theme-20 rounded px-2 mt-1.5">
                      +150
                    </div>
                  </div>
                </div>
              ...
              <div class="flex flex-col sm:flex-row mt-5">
                ...
                <div class="flex">
                  ...
                  <div class="text-center">
                    ...
                    <div class="bg-theme-18 text-theme-21 rounded px-2 mt-1.5">
                      +150
                    </div>
                  </div>
                </div>
              ...
              <div class="flex flex-col sm:flex-row mt-5">
                ...
                <div class="flex">
                  ...
                  <div class="text-center">
                    ...
                    <div class="bg-theme-19 text-theme-22 rounded px-2 mt-1.5">
                      +150
                    </div>
                  </div>
                </div>
                ...
                >
                  <div>
                    ...
                    <div class="progress h-1 mt-2">
                      <div
                        class="progress-bar w-1/2 bg-theme-25"
                        role="progressbar"
                        aria-valuenow="0"
                        aria-valuemin="0"
                        aria-valuemax="100"
                  ...
                  <div class="mt-5">
                    ...
                    <div class="progress h-1 mt-2">
                      <div
                        class="progress-bar w-1/4 bg-theme-25"
                        role="progressbar"
                        aria-valuenow="0"
                        aria-valuemin="0"
                        aria-valuemax="100"
                  ...
                  <div class="mt-5">
                    ...
                    <div class="progress h-1 mt-2">
                      <div
                        class="progress-bar w-3/4 bg-theme-25"
                        role="progressbar"
                        aria-valuenow="0"
                        aria-valuemin="0"
                        aria-valuemax="100"
              ...
              <div class="tab-content">
                ...
                >
                  <div class="flex items-center">
                    <div
                      class="border-l-2 border-theme-25 dark:border-theme-25 pl-4"
                    >
                ...
                <div class="grid grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <div class="flex items-center mt-1 sm:mt-0">
                      <div class="mr-4 w-20 flex">
                        USP:
                        <span class="ml-3 font-medium text-theme-20">+23%</span>
                      </div>
                  ...
                  >
                    ...
                    <div class="flex items-center mt-1 sm:mt-0">
                      <div class="mr-4 w-20 flex">
                        USP:
                        <span class="ml-3 font-medium text-theme-21">-5%</span>
                      </div>
                      <div class="w-5/6 overflow-auto">
                        <SimpleLineChart :height="60" />
                      </div>
                  ...
                  >
                    ...
                    <div class="flex items-center mt-1 sm:mt-0">
                      <div class="mr-4 w-20 flex">
                        USP:
                        <span class="ml-3 font-medium text-theme-21">-10%</span>
                      </div>
                      <div class="w-5/6 overflow-auto">
                        <SimpleLineChart :height="60" />
                      </div>
                  ...
                  >
                    ...
                    <div class="flex items-center mt-1 sm:mt-0">
                      <div class="mr-4 w-20 flex">
                        USP:
                        <span class="ml-3 font-medium text-theme-20">+55%</span>
                      </div>
                      <div class="w-5/6 overflow-auto">
                        <SimpleLineChart :height="60" />
                      </div>
