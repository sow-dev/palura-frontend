      ...
      <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 xl:col-span-9 xxl:col-span-9 z-10">
          <div class="mt-6 -mb-6 intro-y">
            <div
              class="alert alert-dismissible show box bg-theme-25 text-white flex items-center mb-6"
              role="alert"
            >
              <span>
                ...
                >.
                <button
                  class="btn border-transparent bg-theme-26 dark:bg-dark-1 hover:bg-opacity-80 py-0.5 px-2 -my-3 ml-2"
                >
                  Detail
                </button>
              </span>
          ...
          <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
            ...
            >
              ...
              >
                <a
                  ...
                  aria-expanded="false"
                >
                  <MoreVerticalIcon class="w-5 h-5 text-theme-35" />
                </a>
              ...
              <div class="text-white text-sm xxl:text-base font-medium -mb-1">
                Hi Angelina,
                <span class="text-theme-35 dark:text-gray-500 font-normal"
                  >welcome back!</span
                >
              </div>
              <div
                class="text-base xxl:text-lg justify-center sm:justify-start flex items-center text-theme-35 dark:text-gray-500 leading-3 mt-14 xxl:mt-24"
              >
                My Total Assets
                <Tippy
                  tag="div"
              ...
              <div class="xxl:flex mt-5 mb-3">
                <div class="flex items-center justify-center sm:justify-start">
                  <div
                    class="text-white relative text-2xl xxl:text-3xl font-medium leading-6 pl-3 xxl:pl-4"
                  >
                    <span
                ...
                >
                  <Tippy
                    tag="div"
                    class="font-medium inline-flex bg-theme-20 text-white rounded-full px-2 py-1 text-xs xxl:text-sm xxl:p-0 xxl:text-theme-20 xxl:bg-transparent xxl:flex items-center tooltip cursor-pointer xxl:justify-center"
              ...
              <div class="mt-14 xxl:mt-24 dropdown">
                <button
                  class="dropdown-toggle btn btn-rounded bg-theme-25 border-theme-25 text-white w-44 xxl:w-52 px-4 relative justify-start"
                  aria-expanded="false"
                >
                  Download Reports
                  <span
            ...
            >
              <div class="flex flex-wrap items-center">
                ...
                >
                  ...
                  <div class="ml-3.5">
                    <div
                      class="relative text-white text-xl xxl:text-2xl font-medium leading-6 xxl:leading-5 pl-3.5 xxl:pl-4"
                    >
                      <span
                    ...
                    <div class="text-theme-35 dark:text-gray-600 mt-2">
                      Yearly budget
                    </div>
                  </div>
                </div>
            ...
            >
              <div
                class="boxed-tabs nav nav-tabs justify-center w-3/4 xxl:w-4/6 bg-theme-27 text-white dark:bg-dark-2 dark:text-gray-500 rounded-md p-1 mx-auto"
                role="tablist"
              >
                <a
                  id="active-users-tab"
              ...
              <div class="tab-content mt-6">
                ...
                >
                  <div class="relative">
                    ...
                    >
                      <div class="text-white text-xl xxl:text-2xl font-medium">
                        2.501
                      </div>
                      <div class="text-gray-500 dark:text-gray-600 mt-0.5">
                        Active Users
                      </div>
                    </div>
                  </div>
          ...
          <div class="grid grid-cols-12 gap-6 relative intro-y">
            ...
            >
              <div class="flex items-center flex-wrap lg:flex-nowrap gap-3">
                <div
                  class="text-white sm:w-full lg:w-auto text-lg font-medium truncate mr-auto"
                >
                  Summary Report
                </div>
                <div
            ...
            >
              <div class="flex items-center flex-wrap lg:flex-nowrap gap-3">
                ...
                <a
                  href=""
                  class="flex items-center text-white dark:text-theme-25"
                >
              ...
              <div class="flex items-center justify-center mt-10">
                <div class="text-right">
                  <div
                    class="text-white dark:text-gray-300 text-3xl font-medium"
                  >
                    149
                  </div>
                  <div
                    class="text-gray-500 truncate mt-1 text-theme-35 dark:text-theme-35"
                  >
                    Active Lenders
                  </div>
                </div>
          ...
          <div class="h-full flex flex-col">
            <div class="box p-5 mt-6 bg-theme-25 intro-x">
              <div class="flex flex-wrap gap-3">
                ...
                <a
                  class="flex items-center justify-center w-12 h-12 rounded-full bg-theme-26 dark:bg-dark-1 hover:bg-opacity-80 text-white"
                  href=""
                >
        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12 xl:col-span-4 mt-6">
            ...
            <div class="mt-5">
              ...
              <a
                href=""
                class="intro-y w-full block text-center rounded-md py-4 border border-dotted border-theme-32 dark:border-dark-5 text-theme-33 dark:text-gray-600"
                >View More</a
              >
            </div>
          </div>
          ...
          <div class="xxl:pl-6 grid grid-cols-12 gap-6">
            ...
            >
              <div class="intro-x flex items-center h-10">
                ...
                <a
                  href=""
                  class="ml-auto text-theme-30 dark:text-theme-25 truncate"
                  >Show More</a
                >
              </div>
                ...
                <div class="intro-x relative flex items-center mb-3">
                  ...
                  <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                    ...
                    <div class="text-gray-600 mt-1">
                      Has changed
                      <a class="text-theme-30 dark:text-theme-25" href="">{{
                        $f()[7].products[0].name
                      }}</a>
            ...
            <div class="col-span-12 md:col-span-6 xxl:col-span-12 mt-3">
              ...
              <div class="mt-5">
                ...
                <a
                  href=""
                  class="intro-x w-full block text-center rounded-md py-3 border border-dotted border-theme-32 dark:border-dark-5 text-theme-33 dark:text-gray-600"
                  >View More</a
                >
              </div>
            </div>
