      ...
      <div class="col-span-12 xl:col-span-4 xxl:col-span-3">
        ...
        <div class="box p-5 intro-y mt-5">
          ...
          <div class="grid grid-cols-7 gap-4 mt-5 text-center">
            ...
            <div class="py-0.5 bg-theme-17 dark:bg-theme-20 rounded relative">
              6
            </div>
            ...
            <div class="py-0.5 bg-theme-18 dark:bg-theme-29 rounded relative">
              23
            </div>
            <div class="py-0.5 rounded relative">24</div>
            <div class="py-0.5 rounded relative">25</div>
            <div class="py-0.5 rounded relative">26</div>
            <div class="py-0.5 bg-theme-19 dark:bg-theme-15 rounded relative">
              27
            </div>
          ...
          <div class="border-t border-gray-200 dark:border-dark-5 pt-5 mt-5">
            ...
            <div class="flex items-center mt-4">
              <div
                class="w-2 h-2 bg-theme-25 dark:bg-theme-10 rounded-full mr-3"
              ></div>
