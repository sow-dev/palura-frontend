      ...
      <div class="grid grid-cols-12 gap-6">
          ...
          <div class="report-box-2 intro-y mt-12 sm:mt-5">
            <div class="box sm:flex">
              <div class="px-8 py-12 flex flex-col justify-center flex-1">
                <ShoppingBagIcon class="w-10 h-10 text-theme-15" />
                ...
                <Tippy
                  tag="div"
                  class="report-box-2__indicator bg-theme-20 cursor-pointer"
              ...
              >
                ...
                <div class="mt-1.5 flex items-center">
                  ...
                  <Tippy
                    tag="div"
                    class="text-theme-21 flex text-xs font-medium cursor-pointer ml-2"
                ...
                <div class="mt-1.5 flex items-center">
                  ...
                  <Tippy
                    tag="div"
                    class="text-theme-20 flex text-xs font-medium cursor-pointer ml-2"
        ...
        <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3 mt-2">
          <div class="intro-y flex items-center h-10">
            ...
            <a href="" class="ml-auto text-theme-30 dark:text-theme-25 truncate"
              >View on Map</a
            >
          </div>
          <div class="report-box-2 intro-y mt-5">
            <div class="box p-5">
              ...
              <div class="border-b border-gray-200 flex pb-2 mt-4">
                ...
                <Tippy
                  tag="div"
                  class="text-theme-20 flex text-xs font-medium cursor-pointer ml-auto"
                ...
                >
                  ...
                  <div class="mt-5">
                    ...
                    <div class="flex items-center mt-4">
                      <div class="w-2 h-2 bg-theme-30 rounded-full mr-3"></div>
        ...
        <div class="col-span-12 lg:col-span-6 mt-6">
          <div
            class="ads-box box p-8 relative overflow-hidden bg-theme-24 intro-y"
          >
        ...
        <div class="col-span-12 lg:col-span-6 mt-6">
          <div class="ads-box box p-8 relative overflow-hidden intro-y">
            <div
              class="ads-box__title w-full sm:w-52 text-theme-30 dark:text-white text-xl -mt-3"
            >
        ...
        <div class="xxl:pl-6 grid grid-cols-12 gap-6">
          ...
          >
            ...
            <div class="mt-5">
              ...
              <a
                href=""
                class="intro-y w-full block text-center rounded-md py-3 border border-dotted border-theme-32 dark:border-dark-5 text-theme-33 dark:text-gray-600"
                >View More</a
              >
            </div>
          </div>
              ...
              <div class="intro-x box">
                <div class="p-5">
                  ...
                  <div class="grid grid-cols-7 gap-4 mt-5 text-center">
                    ...
                    <div
                      class="py-0.5 bg-theme-17 dark:bg-theme-20 rounded relative"
                    >
                      6
                    </div>
                    <div class="py-0.5 rounded relative">7</div>
                    <div
                      class="py-0.5 bg-theme-24 dark:bg-theme-25 text-white rounded relative"
                    >
                      8
                    </div>
                    ...
                    <div
                      class="py-0.5 bg-theme-18 dark:bg-theme-29 rounded relative"
                    >
                      23
                    </div>
                    ...
                    <div
                      class="py-0.5 bg-theme-19 dark:bg-theme-15 rounded relative"
                    >
                      27
                    </div>
