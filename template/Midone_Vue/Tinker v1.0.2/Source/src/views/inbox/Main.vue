  ...
  <div class="grid grid-cols-12 gap-6 mt-8">
    <div class="col-span-12 lg:col-span-3 xxl:col-span-2">
      ...
      <div class="intro-y box bg-theme-1 p-5 mt-6">
        <button
          type="button"
          class="btn text-gray-700 dark:text-gray-300 w-full bg-white dark:bg-theme-25 mt-1"
        >
        ...
        >
          <a
            href=""
            class="flex items-center px-3 py-2 rounded-md bg-theme-25 dark:bg-dark-1 font-medium"
          >
