      ...
      >
        <div class="intro-y box mt-5 lg:mt-0">
                ...
                <div class="dropdown-menu__content box dark:bg-dark-1">
                  ...
                  <div class="p-2">
                    ...
                    >
                      ...
                      Indonesia
                      <div
                        class="text-xs text-white px-1 rounded-full bg-theme-21 ml-auto"
                      >
                        10
                      </div>
                    </a>
          ...
          <div class="p-5 border-t border-gray-200 dark:border-dark-5">
            <a
              class="flex items-center text-theme-25 dark:text-theme-22 font-medium"
              href=""
            >
            ...
            <TinySlider ref-key="newProjectsRef" class="py-5">
              ...
              <div class="px-5">
                ...
                <div class="mt-5">
                  ...
                  >
                    <div class="w-1/2 h-full bg-theme-25 rounded-full"></div>
                  </div>
                </div>
              </div>
              <div class="px-5">
              ...
              <div class="tab-content mt-8">
                ...
                >
                  <div class="flex flex-col sm:flex-row items-center">
                    ...
                    >
                      <div class="bg-theme-17 text-theme-20 rounded px-2 mr-5">
                        +20%
                      </div>
                  ...
                  <div class="flex flex-col sm:flex-row items-center mt-5">
                    ...
                    >
                      ...
                      <div class="progress h-1 mt-2 sm:w-40">
                        <div
                          class="progress-bar w-2/3 bg-theme-25"
                          role="progressbar"
                          aria-valuenow="0"
                          aria-valuemin="0"
                          aria-valuemax="100"
              ...
              <div class="tab-content">
                ...
                >
                  ...
                  <div class="mt-5">
                    ...
                    <div class="progress h-1 mt-2">
                      <div
                        class="progress-bar w-4/5 bg-theme-25"
                        role="progressbar"
                        aria-valuenow="0"
                        aria-valuemin="0"
                        aria-valuemax="100"
