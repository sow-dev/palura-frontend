    ...
    <div class="intro-y box overflow-hidden mt-5">
      ...
      >
        <div>
          ...
          <div
            class="text-lg font-medium text-theme-17 dark:text-gray-300 mt-2"
          >
        ...
        <div class="mt-10 lg:mt-0 lg:ml-auto lg:text-right">
          ...
          <div
            class="text-lg text-theme-17 dark:text-gray-300 font-medium mt-2"
          >
            #1923195
          </div>
      ...
      >
        ...
        <div class="text-center sm:text-right sm:ml-auto">
          ...
          <div
            class="text-xl text-theme-17 dark:text-gray-300 font-medium mt-2"
          >
            $20.600.00
          </div>
