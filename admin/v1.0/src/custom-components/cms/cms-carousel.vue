                    ...
                    <div class="sm:grid grid-cols-2 gap-2">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="amount" min="1" step="1"
                                aria-describedby="input-group-3" v-model="ds.displayAmount" />
                        </div>
                ...
                <div class="mt-0">
                    ...
                    <div class="sm:grid grid-cols-2 gap-2">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="amount" min="1" step="1"
                                aria-describedby="input-group-3" v-model="ds.speed" />
                        </div>
                        <div class="input-group">
                            <div id="input-group-3" class="input-group-text w-24">interval</div>
                            <input id="royalties" type="number" class="form-control w-full" min="1" max="50"
                                step="1" placeholder="" v-model="ds.interval" />
                        </div>
                    </div>
                </div>
                <div class="mt-0">
                    ...
                    <div class="sm:grid grid-cols-2 gap-2">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="amount" min="1" step="1"
                                aria-describedby="input-group-3" v-model="ds.height" />
                        </div>
                        <div class="input-group">
                            <div id="input-group-3" class="input-group-text w-24">item width</div>
                            <input id="royalties" type="number" class="form-control w-full" min="1" max="50"
                                step="1" placeholder="" v-model="ds.itemWidth" />
                        </div>
                    </div>
                </div>
            </div>
