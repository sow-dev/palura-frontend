...
const providerUrl = 'https://eth-rinkeby.alchemyapi.io/v2/Qx9xAtwZA9T906TxAwwx5o-VoiEjFvE0'

// const MNEMONIC = "venue muscle alter voice toddler saddle loyal auto toilet captain job whisper"; //process.env.MNEMONIC;
const MNEMONIC = "fancy stick blossom invest belt snap sunset cat business trade range lazy";
...
module.exports = {
    config: {
        ...
        apiOrderUrl: 'https://54zucrbine.execute-api.ap-northeast-2.amazonaws.com/dev/v1', // dev-product
        apiBidUrl: 'https://ld1r1yqmj0.execute-api.ap-northeast-2.amazonaws.com/dev/v1', // dev-bid
