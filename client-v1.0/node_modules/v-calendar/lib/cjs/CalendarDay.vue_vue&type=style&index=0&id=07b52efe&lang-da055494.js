'use strict';var helpers=require('./helpers-61ebb0aa.js'),vue=require('vue'),index=require('./index-01c0aae0.js'),styleInject_es=require('./style-inject.es-06def3b0.js');function showPopover(opts) {
  if (document) {
...
function getPopoverTriggerEvents(opts) {
  ...
  render: function render() {
    ...
    return vue.h('div', {
      class: ['vc-day'].concat(helpers.D(this.day.classes), [{
    ...
    refreshPopovers: function refreshPopovers() {
      ...
      if (helpers.l(this.popovers)) {
        popoverEvents = getPopoverTriggerEvents(helpers.T.apply(void 0, [{
          ...
          data: this.day,
          isRenderFn: true
        }].concat(helpers.D(this.popovers))));
      }
