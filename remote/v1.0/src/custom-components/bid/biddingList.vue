            ...
            <div class="flex flex-col lg:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                ...
                <div class="flex -ml-2 lg:ml-0 lg:justify-end mt-3 lg:mt-0">
                    ...
                    <div class="flex flex-row"> 
                      <div class="text-xl font-medium leading-8 ">Bid-Price: {{i.price}} {{i.symbol}} </div>
                    ...
                    <!-- 리저브 가격 도달 여부 표시 -->
                    <div class="ml-4 text-sm font-bold text-red-400 leading-8" v-if="i.is_reserve && i.reserve_price > i.price"> <!-- TODO: 디자인 필요 -->
                      fail to reach reserved-price({{i.reserve_price}})
                    </div>
